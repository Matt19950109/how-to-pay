class SpendingsController < ApplicationController
  ...
  def index
    ...
    #@spendings_count = current_user.spendings.where(start_time: [Date.today.all_month]).group(:start_time).count
    @total = current_user.spendings.group("MONTH(start_time)")
